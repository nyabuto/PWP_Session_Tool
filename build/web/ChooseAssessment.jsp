<%-- 
    Document   : ChooseAssessment
    Created on : Mar 2, 2015, 10:22:30 AM
...
//-->
        ...
        <title>Choose client to assess</title>
...
$("#demo").html("<table cellpadding='4px' cellspacing='4px' style='padding-top: 1px;' border='0' class='display' id='example'><tr><td>Loading Data...<img src='images/utube.gif' alt='.'></td></tr></table>");
  $.ajax({
               url:"loadAsesser?partner="+part+"&&district="+dist,
               type:"post",
               dataType:"html",
...
$("#demo").html("<table cellpadding='4px' cellspacing='4px' style='padding-top: 1px;' border='0' class='display' id='example'><tr><td>Loading Data...<img src='images/utube.gif' alt='.'></td></tr></table>");
 $.ajax({
               url:"loadAsesser?partner="+partner+"&&district="+district,
               type:"post",
               dataType:"html",
               success:function(data){
               $("#example").html(data);
...
<div style="margin-left: 100px; margin-top: -10px; color: #000; background: #d6b4eb; font-size: 24px; text-align: center;">Choose client to assess.<img src="images/help.png" id="opener" title="Click Here to view Help For this Page." alt=" Help Image " style=" width: 40px; height: 40px;"></h4></div>
 <%if (session.getAttribute("addedAssessment") != null) { %>
                                <script type="text/javascript"> 
                    
                    var n = noty({text: '<%=session.getAttribute("addedAssessment")%>',
                        layout: 'center',
                        type: 'Success',
                ...
                session.removeAttribute("addedAssessment");
                            }
%>
<br>
<div id="midcontent" style="margin-left:10px ; height: auto">
<div id="dialog" title="Edit Clients." style=" font-size: 17px;">
 <p>1. Select the county , partner and district where the client whom you want to access was registered.</p>
 <p>2. Use the search box provided to search for the client you want to access.</p>
 <p>3. Upon finding the client, click on assess.</p>
 <p>4. <font color="red">NOTE : </font>, Users are only able to edit the assessment form for those clients who have already been assessed. </p>
</div>

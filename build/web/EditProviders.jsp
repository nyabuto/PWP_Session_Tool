<%-- 
    Document   : EditProviders
    Created on : Dec 11, 2014, 1:34:20 AM
...
//-->
        ...
        <title>Edit Service Providers</title>
...
<div style="margin-left: 0px; margin-top: -10px; color: #000; background: #d6b4eb; font-size: 24px; text-align: center;">Edit Service Provider Details.<img src="images/help.png" id="opener" title="Click Here to view Help For this Page." alt=" Help Image " style=" width: 40px; height: 40px;"></h4></div>

<br>
<div id="midcontent" style="margin-left:100px ; height: auto">
<div id="dialog" title="Edit Provider Help." style=" font-size: 17px;">
    ...
    <p><img src="images/editProvider.JPG" alt='editor image' style='height: 150px; width: 500px;'></p>
    <p>e.g double click where the arrow points to as shown above...</p>
    <p>Users are able to edit first,middle, last name and also phone number. </p>

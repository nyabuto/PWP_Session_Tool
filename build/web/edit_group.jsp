...
xmlhttp.send();
 ...
 function load_edit_group(){
        ...
        if(group_id=="0"){
            alertify.alert("Please Select a Group To Edit Details. This Is not a group.")
...
xmlhttp.open("POST","load_edit_group?group_id="+group_id,true);
xmlhttp.send();
}
//set the partner
 }
...
<div >    <h4 style=" font-size: 23px;">Specify details appropriately to Edit Group Details.<img src="images/help.png" id="opener" title="Click Here to view Help For this Page." alt=" Help Image " style=" width: 40px; height: 40px;"></h4></div> 
...
<p style=" font-size: 20px;"><font color="red">*</font> indicates must fill/select fields</p>
<form action="edit_group2.jsp" method="post" onsubmit=" return load_edit_group();">
...
<td><Select id="group" class="textbox2"  required ="true" onchange=" return load_edit_group();" name="group" >

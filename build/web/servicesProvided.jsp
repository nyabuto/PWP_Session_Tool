<%-- 
    ...
    Created on : Nov 19, 2014, 12:08:25 AM
...
<div style="margin-left: 300px;width: 550px; margin-top: -10px; color: #000; background: #d6b4eb; font-size: 24px; text-align: center;">Services Provided report.<img src="images/help.png" id="opener" title="Click Here to view Help For this Page." alt=" Help Image " style=" width: 40px; height: 40px;"></div>

<br>
<div id="midcontent" style="margin-left:230px ; height: auto">
<div id="dialog" title="Services provided." style=" font-size: 17px;">
<p>This report shows the services that were provided within the selected period.</p>
</div>
<!--<p style=" font-size: 20px;"><font color="red" >*</font> indicates must select fields</p>-->
<form action="sessionsBetween" method="post">

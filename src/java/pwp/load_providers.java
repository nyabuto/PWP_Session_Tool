...
String partner_id,district,providers;
HttpSession session;
...
String full_name="";
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           providers="<option name=\"\">Choose Provider</option>";
           fname=mname=lname="";
           
           
           String provider_selector="SELECT * FROM service_provider WHERE partner_id='"+partner_id+"' && district_id='"+district+"'";
...
if(conn.conn!=null){conn.conn.close();}
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet load_providers</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>" +providers+ "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {            
            out.close();

 ...
 */
public class a_individual_session_loader extends HttpServlet {
HttpSession session;
String session_rows;
...
//        sess_no=Integer.parseInt(session.getAttribute("chosen_session").toString());
...
if(conn.conn!=null){conn.conn.close();}
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(a_individual_session_loader.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

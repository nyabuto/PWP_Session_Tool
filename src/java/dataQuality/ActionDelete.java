...
//       DELETE MAIN CLIENTS ENTRY===============================
       String getDetails="SELECT client_id,fname,mname,lname,dob,gender,group_id,ccc_no,district_id,partner_id,lessons_attended,national_id,hiv_year,provider_id,timestamp,completionyear,completionmonth FROM personal_information WHERE client_id='"+id+"'";

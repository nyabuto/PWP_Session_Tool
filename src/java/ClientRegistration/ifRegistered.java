 ...
 */
public class ifRegistered extends HttpServlet {
HttpSession session;
...
client_id="";
         ...
         String checker="SELECT personal_information.fname,personal_information.mname,personal_information.lname,"
                 ...
                 + "WHERE personal_information.fname=? && personal_information.lname=?";
         ...
         if(pmname.equalsIgnoreCase(plname)){
          ...
          status+="<p style=\"font-size:15px; color: black; text-align:center\">"+pos+". Client name : <font color=\"blue\">"+client_name+"</font>, Service provider : <font color=\"blue\">"+serviceProvider+"</font>, Group name : <font color=\"blue\">"+groupName+"</font>, District : <font color=\"blue\">"+districtName+"</font>, <a href=\"LoadEditClient?client_id="+client_id+"\" class=\"button-link\" style=\"font-color: white;\">Click here to edit his/her registration form.</a><br></p>";   
             
             
         }
         if(pos==1){
         data="<p style=\"text-align:center;color:red;\" id=\"shaker\"><b>CLIENT WITH SIMILAR NAME EXIST IN THE SYSTEM AS SHOWN BELOW.</b></p>";
         }
         if(pos>1){
          data="<p style=\"text-align:center;color:red;\" id=\"shaker\"><b>CLIENTS WITH SIMILAR NAME EXIST IN THE SYSTEM AS SHOWN BELOW.</b></p>";   
         }
...
if(conn.conn!=null){conn.conn.close();}
    ...
    try {
        ...
        Logger.getLogger(ifRegistered.class.getName()).log(Level.SEVERE, null, ex);
    }
    }

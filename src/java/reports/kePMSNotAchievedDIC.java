 ...
 */
public class kePMSNotAchievedDIC extends HttpServlet {
HttpSession session;
...
"END AS SEX"
              ...
              + " WHERE personal_information.partner_id='"+partner_id+"' && personal_information.lessons_attended>0 && personal_information.completionyear=0 "
...
response.setHeader("Content-Disposition", "attachment; filename=PWP_kePMS_REPORT_FOR_NOT_ACHIEVED_PER_DIC_FOR_"+partnername.trim()+".xlsm");
...
pkg.close();
    ...
    try {
        ...
        Logger.getLogger(kePMSNotAchievedDIC.class.getName()).log(Level.SEVERE, null, ex);

<%-- 
    Document   : add_a_clients2
    Created on : Apr 1, 2014, 2:38:01 PM
...
<%
    ...
    if ((session.getAttribute("userid")==null) || (session.getAttribute("group_name")==null)||(session.getAttribute("district_name")==null)||(session.getAttribute("partner_name")==null)) {
...
function load_sessions(){
        ...
        var group_id=<%=session.getAttribute("group_id").toString()%>;
//       alert(group_id)
if(group_id=="0"){
 load_individuals();
}
...
<div style="margin-left: 300px;width: 550px; margin-top: -10px; color: #000; background: #d6b4eb; font-size: 24px; text-align: center;">STEP 3/6. Continuation... Add New Clients.</div>
...
<tr><th>No.</th><th>First Name <font color="red">*</font></th><th>Middle Name</th><th>Last Name <font color="red">*</font></th><th>Age <font color="red">*</font></th><th>Gender <font color="red">*</font></th></tr>

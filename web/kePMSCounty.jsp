...
<html>
    <head>
        <title>KePMS Report per county </title>
...
<div style="margin-left: 300px;width: 550px; margin-top: -10px; color: #000; background: #d6b4eb; font-size: 24px; text-align: center;">kePMS report per county.</div>
...
<form action="kePMSCounty" method="post"><br><br>
...
<tr> <td class="align_button_right" style=" font-size: 18px;">Choose Pepfar Year<font color="red">*</font></td>
    <td>  
    <select name="year" id="year" required class="textbox2">

...
<div style="margin-left: 300px;width: 550px; margin-top: -10px; color: #000; background: #d6b4eb; font-size: 24px; text-align: center;">Edit Attendance.</div>


<div id="midcontent" style="margin-left:230px ; height: auto;">
<div > <h4 style=" font-size: 23px;">Select details appropriately to Edit Attendance.<img src="images/help.png" id="opener" title="Click Here to view Help For this Page." alt=" Help Image " style=" width: 40px; height: 40px;"></h4></div> 
...
<option value="">Choose District</option>  
        ...
        <%if(session.getAttribute("district_id")!=null && session.getAttribute("partner_id")!=null && session.getAttribute("group_name_s")!=null) {%>

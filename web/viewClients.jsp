...
<tr id="${AList.clientid}">
    <td  class="sorting_1">${AList.county}</td>
    <td  class="sorting_1">${AList.partner}</td>
    <td  class="sorting_1">${AList.district}</td>  
    <td  class="sorting_1">${AList.group}</td> 
    <td  class="sorting_1">${AList.clientname}</td>
    <td  class="sorting_1">${AList.age}</td>
    <td  class="sorting_1">${AList.gender}</td>
    <td  class="sorting_1">${AList.attended}</td>  
    <td  class="sorting_1"><a class="linkstyle" href="DeleteClients?<%=uuid%>&&id=${AList.clientid}&&<%=uuid2%>" onclick="return deleter();">DELETE</a></td>

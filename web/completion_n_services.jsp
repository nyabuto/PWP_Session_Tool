<%-- 
    Document   : completion_n_services
    Created on : Mar 20, 2014, 10:24:33 AM
...
<title>Services provided report per county</title>
...
<div style="margin-left: 300px;width: 550px; margin-top: -10px; color: #000; background: #d6b4eb; font-size: 24px; text-align: center;">Partner(s) completion rate report.</div>


<div id="midcontent" style="margin-left:230px ; height: auto">
<div >    <h4 style=" font-size: 23px;">Specify details appropriately to generate services provided report.<img src="images/help.png" id="opener" title="Click Here to view Help For this Page." alt=" Help Image " style=" width: 40px; height: 40px;"></h4></div> 
<div id="dialog" title="Add Clients Help." style=" font-size: 17px;">
<%  String message1="Selct detsils appropriately to generate completion report";
dbConn conn = new dbConn();
String message_selector="SELECT * FROM help WHERE help_id='221'";
...
<form action="report_decider" method="post">
    <input type="hidden" name="src" value="completion_versus_services.jsp">
...
<tr> <td class="align_button_right" style=" font-size: 18px;">Choose Period (s)<font color="red">*</font></td>
    <td><select name="period" id="period" class="textbox2"   required ="true" style="height: 90px;" multiple>
